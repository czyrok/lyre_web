...
function Le(t) {
  // console.log('data61', !!(t && t.type === "Function" && t.name === "anchor"))
...
function pn(t) {
  // console.log('data62', !!(t && t.type === "Function" && t.name === "anchor-size"))
...
function Pp(t, e) {
  ...
  if (Le(t)) {
    // TODO: lui
    console.log('data60-3') 
  }
  if (pn(t)) {
    console.log('data60-4') 
  }
    // console.log('data60-2', t.name === 'anchor', T.name === 'anchor-size')
  if ((Le(t) || pn(t)) && e) {
    console.log('data60')
  ...
  return R(this, null, function* () {
    ...
    for (const k of t) {
      ...
      Et(w, function(E) {
        ...
        // TODO: Pp = getAnchorFunctionData
        const {
          prop: A,
          data: j,
          changed: D
        } = Pp(E, this.declaration);
        console.log('data54', A, j)
        if (A && j && L.length)
          for (const { selector: B } of L) {
            console.log('data55', B)

        e[B] = q(W({}, e[B]), {
              [A]: [...(ft = (xt = e[B]) == null ? void 0 : xt[A]) != null ? ft : [], j]
            });
          console.log('data51-3', e)
          }
    ...
    console.log('data51', e)
    // TODO: e vide après = anchorFunctions
      ...
      for (const [E, _] of Object.entries(O)) {
        ...
        for (const L of _) {
          ...
          for (const A of w) {
            ...
            console.log('donnes quon cherche', D)
      ...
      for (const o of s) {
        ...
        if (a && l) {
          ...
          if (machin) {
            ...
            console.log('data7', n.style)
            // TODO: probablement lui qui fait iech
            // FIXME: ICI -> bug 1
            let clean = en(
              a,
              l,
