...
links:
  - url: https://TODO.xx.com XX
    title: GitHub
    icon: GITHUB
---

Parlons un peu de mon **homelab** overkill 😂. T'as compris que je ne fais jamais les choses à moitié, et mon homelab n'y échappe pas. C'est d'ailleurs là que [dylan-valentin.dev](https://dylan-valentin.dev) est hébergé...
...
Prochaine étape : un cluster **K3s** et l'utilisation de **Proxmox** 😎.
