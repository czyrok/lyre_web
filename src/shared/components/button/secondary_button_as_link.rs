...
pub fn SecondaryButtonAsLink(
    ...
    view! {
        <UnthemedButtonAsLink theme=ButtonTheme::Secondary size=size text=text href=href icon=icon icon_side=icon_side target=target />
    }
}
